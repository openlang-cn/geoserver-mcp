...
def create_style(
    name: Annotated[str, Field(description="样式名称")],
    sld: Annotated[str, Field(description="SLD 样式 XML 字符串")],
    workspace: Annotated[str | None, Field(description="工作区名称，不填则为全局样式")] = None,
) -> dict:
    """创建样式。"""
...
def upload_style(
    path: Annotated[str, Field(description="样式文件路径（.sld 或 .xml，相对于 storage 目录或绝对路径）")],
    name: Annotated[str | None, Field(description="样式名称，默认使用文件名")] = None,
    workspace: Annotated[str | None, Field(description="工作区名称，不填则为全局样式")] = None,
    sld_version: Annotated[str, Field(description="SLD 版本，如 1.0.0、1.1.0，默认 1.0.0")] = "1.0.0",
) -> dict:
    """上传样式文件或 SLD XML。"""
...
def get_style(
    name: Annotated[str, Field(description="样式名称")],
    workspace: Annotated[str | None, Field(description="工作区名称，不填则查找全局样式")] = None,
) -> dict:
    """获取单个样式详情。"""
...
def get_styles(
    workspace: Annotated[str | None, Field(description="工作区名称，不填则列出所有样式")] = None,
) -> dict:
    """列出样式。"""
...
def create_catagorized_featurestyle(
    style_name: Annotated[str, Field(description="样式名称")],
    column_name: Annotated[str, Field(description="用于分类的属性列名")],
    column_distinct_values: Annotated[str, Field(description="属性列的 distinct 值列表，逗号分隔")],
    workspace: Annotated[str | None, Field(description="工作区名称")] = None,
    color_ramp: Annotated[str | None, Field(description="色带名称，如 viridis、plasma、Reds，或颜色列表")] = None,
    geom_type: Annotated[str | None, Field(description="几何类型：polygon、line、point")] = None,
) -> int:
    """创建分类矢量样式。"""
...
def create_classified_featurestyle(
    style_name: Annotated[str, Field(description="样式名称")],
    column_name: Annotated[str, Field(description="用于分级的数值属性列名")],
    column_distinct_values: Annotated[str, Field(description="属性列的 distinct 值列表，逗号分隔")],
    workspace: Annotated[str | None, Field(description="工作区名称")] = None,
    color_ramp: Annotated[str | None, Field(description="色带名称，如 viridis、plasma、Reds，或颜色列表")] = None,
    geom_type: Annotated[str | None, Field(description="几何类型：polygon、line、point")] = None,
...
def create_outline_featurestyle(
    style_name: Annotated[str, Field(description="样式名称")],
    outline_color: Annotated[str, Field(description="轮廓颜色，如 #FF0000、red")],
    workspace: Annotated[str | None, Field(description="工作区名称")] = None,
    width: Annotated[str, Field(description="轮廓线宽，默认 2")] = "2",
    geom_type: Annotated[str, Field(description="几何类型：polygon、line、point，默认 polygon")] = "polygon",
) -> int:
    """创建仅轮廓样式。"""
...
def style_catagorize_xml(
    column_name: Annotated[str, Field(description="用于分类的属性列名")],
    values: Annotated[list, Field(description="分类值列表，如 [\"urban\", \"rural\", \"water\"]")],
    color_ramp: Annotated[str | None, Field(description="色带名称，如 viridis、plasma、Reds，或颜色列表")] = None,
    geom_type: Annotated[str, Field(description="几何类型：polygon、line、point，默认 polygon")] = "polygon",
) -> str:
    """生成分类样式 SLD XML。"""
...
def style_classified_xml(
    style_name: Annotated[str, Field(description="样式名称")],
    column_name: Annotated[str, Field(description="用于分级的数值属性列名")],
    values: Annotated[list, Field(description="分级区间值列表，如 [0, 100, 500, 1000]")],
    color_ramp: Annotated[str | None, Field(description="色带名称，如 viridis、plasma、Reds，或颜色列表")] = None,
    geom_type: Annotated[str, Field(description="几何类型：polygon、line、point，默认 polygon")] = "polygon",
) -> str:
    """生成分级样式 SLD XML。"""
...
def style_coverage_style_colormapentry(
    color_ramp: Annotated[Any, Field(description="色带名称或颜色列表")],
    min_value: Annotated[float, Field(description="最小值")],
    max_value: Annotated[float, Field(description="最大值")],
    number_of_classes: Annotated[int | None, Field(description="分级数，默认 5")] = None,
) -> str:
    """生成栅格色带条目。"""
    style_module = get_style_module()
...
def style_coverage_style_xml(
    color_ramp: Annotated[Any, Field(description="色带名称或颜色列表")],
    style_name: Annotated[str, Field(description="样式名称")],
    cmap_type: Annotated[str, Field(description="色带类型：ramp(渐变)、intervals(分段)")],
    min_value: Annotated[str, Field(description="最小值")],
    max_value: Annotated[str, Field(description="最大值")],
    number_of_classes: Annotated[str, Field(description="分级数")],
    opacity: Annotated[str, Field(description="不透明度，0.0-1.0")],
) -> str:
    """生成栅格样式 XML。"""
    style_module = get_style_module()
    normalized_ramp = _normalize_color_ramp(color_ramp, number_of_classes)
...
def style_outline_only_xml(
    color: Annotated[str, Field(description="轮廓颜色，如 #FF0000、red")],
    width: Annotated[float, Field(description="轮廓线宽")],
    geom_type: Annotated[str, Field(description="几何类型：polygon、line、point，默认 polygon")] = "polygon",
) -> str:
    """生成轮廓样式 XML。"""
    style_module = get_style_module()
